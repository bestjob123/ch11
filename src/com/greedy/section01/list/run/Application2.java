...
//			bookList.forEach(System.out::println);
			...
			System.out.println("가격 순 오름 차순 정렬 ==================");
			for(BookDTO book : bookList) {
				System.out.println(book);
			}
...
//			});
			...
			System.out.println("제목 순 오른차순 정렬 ====================");
			for(BookDTO book : bookList) {
				System.out.println(book);
			}
			/* 제목 순 내림차순 정렬*/
			...
			System.out.println("제목 순 내림 차순 정렬 ======================");
			for(BookDTO book : bookList) {
				System.out.println(book);
			}
			...
			System.out.println("작가 순 오름 차순 정렬 ======================");
			for(BookDTO book : bookList) {
				System.out.println(book);
			}
			bookList.sort(new Comparator<BookDTO>() {
				@Override
				public int compare(BookDTO o1, BookDTO o2)    {
					return o1.getAuthor().compareTo(o2.getTitle())*-1;
					
				}
			});
			System.out.println("작가 순 내림 차순 정렬 ========================");
			for(BookDTO book : bookList) {
				System.out.println(book);
			}
	}
